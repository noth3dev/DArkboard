...
export default function LegacyPage() {
    ...
    return (
        <div className="min-h-[calc(100vh-65px)] bg-black text-white p-4 sm:p-6 md:p-12 overflow-x-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="space-y-12 mb-20">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 bg-neutral-900/20 p-2 rounded-3xl border border-neutral-900">
